...
class CorefModel(object):
  ...
  def get_predictions_and_loss(self, input_ids, input_mask, segment_ids, use_one_hot_embeddings, text_len, speaker_ids, genre, is_training, gold_starts, gold_ends, cluster_ids):
